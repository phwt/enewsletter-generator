document.getElementById("title").value = getSavedValue("title");    
	...
	function savei(){
		...
		//Stupid code before I know 'for' is exist.
		/*if(lv == 1){
			l1 = document.getElementById("l1").value;
			length = 60;
			flength = 855;
	...
	function showp(e){
			...
			//var isy_r = document.getElementById("issue_yr").value;
