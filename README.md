...
## To-do list
 ...
 - [ ] Fullly Migration from Legacy Version
     - [X] Remove all non-project related content.
...
## Built with
 ...
 - [Adobe Color CC](https://color.adobe.com/) - Provide me a color scheme for placeholder header/footer.
